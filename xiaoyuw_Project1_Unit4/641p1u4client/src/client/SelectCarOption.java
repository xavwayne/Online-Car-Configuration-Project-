...
public class SelectCarOption {
     ...
     */
    public synchronized void showCars() {
	String HOST = null;
	try {
     ...
     * @throws Exception
     */
    public void select(ObjectInputStream in, ObjectOutputStream out)
	    throws Exception {
	...
	while (true) {
	    System.out
		    .println("Set your configuration with format \"OptionSet:Optoin\". Type 'q' to finish configuration.");
	    ...
	    if (s.length < 2) {
		System.out
			.println("Format Error. please retype \"OptionSet:Optoin\"");
		continue;
	    }
	    String optset = s[0];
	    String opt = s[1];
