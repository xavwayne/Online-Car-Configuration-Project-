...
public class Automobile implements Serializable {
     ...
     * @throws AutoException
     */
    public synchronized void setOpt(String optset, int index, String name,
     ...
     * @throws AutoException
     */
    public synchronized void setOpt(String optset, String name, float price)
	    throws AutoException {
	OptionSet os = findOptset(optset);
	if (os != null) {
     ...
     * @throws AutoException
     */
    public synchronized void setOpt(String optset, String name)
	    throws AutoException {
	OptionSet os = findOptset(optset);
	if (os != null) {
	    os.setOpt(name);
     ...
     * @throws AutoException
     */
    public synchronized void delOpt(String opt, String optset)
	    throws AutoException {
     ...
     * @throws AutoException
     */
    public synchronized void delOpt(int index, String optset)
	    throws AutoException {
	OptionSet os = this.findOptset(optset);
     ...
     * @throws AutoException
     */
    public synchronized void upDateOptset(String optset, String optname,
     ...
     * @throws AutoException
     */
    public synchronized void upDateOpt(String optset, String optname,
     ...
     * @throws AutoException
     */
    public synchronized void upDateOpt(String optset, int index, float newprice)
	    throws AutoException {
	OptionSet os = this.findOptset(optset);
