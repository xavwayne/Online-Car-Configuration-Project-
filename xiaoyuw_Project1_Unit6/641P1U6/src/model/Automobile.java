...
public class Automobile implements Serializable {
	...
	public float getOptPrice(String optset,String opt) throws AutoException{
	    OptionSet os=this.findOptset(optset);
	    Option o=os.getOpt(opt);
	    return o.getPrice();
	}
	
	public  void displayOptionChoice() {
	...
	public  void setOptionChoice(String setname, String optname) throws AutoException {
