...
public abstract class ProxyAutomobile {
	...
	do {
		...
		Update sqlup = new Update();
		sqlup.updateOptsetName(modelname, optionsetname, newname);
	...
	do {
		...
		fleet.updateOptionPrice(modelname, optionsetname, option,
			newprice);
		Update sqlup = new Update();
		sqlup.updateOptionPrice(modelname, optionsetname, option,
			newprice);
		flag = true;
	...
	Create sqlinsert = new Create();
	sqlinsert.insert(at);// add into database
	...
	try {
	    Automobile at = fleet.deleteAutomobile(modelname);
	    Delete sqldel = new Delete();
	    sqldel.delete(at);
	} catch (AutoException e) {
	    e.printStackTrace();
	}
